...
define('BASE_URL', 'http://prittynote.com/');
...
//PapPal Transactions Config
define('ENVIROMENT', 'www.paypal.com'); //www.sandbox.paypal.com
define('BUSINESS_EMAIL', 'skasivwa@gmail.com'); //eugene_1356286758_per@gmail.com
define('EMAIL', 'no.reply.prittynote@gmail.com'); //define admin email address here!!
...
mail(EMAIL, 'Site Error!', $message, 'From: '.EMAIL);
